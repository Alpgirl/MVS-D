...
class tcnnNeRFModel(torch.nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        # self.encoding = pointnet_utils.IdentityEncoding(scale=config["encoding"]["scale"], offset=config["encoding"]["offset"])
        # self.network = pointnet_utils.SimpleMLP(n_input_dims=dims[0], n_output_dims=1, network_config=config["network"])
